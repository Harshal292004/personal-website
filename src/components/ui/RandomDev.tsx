...
const RandomDev = () => {
    ...
    return (
        <div className="w-full py-8 md:py-16 relative bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-900 dark:to-zinc-900 border-y-4 md:border-y-8 border-black dark:border-gray-200 overflow-hidden">
            ...
            {/* Decorative elements */}
            <Pulsar size={40} color={theme === "dark" ? "#EAB308" : "#fdba74"} className="top-8 left-8 md:top-12 md:left-16" />
            <Pulsar size={30} color={theme === "dark" ? "#FACC15" : "#fb923c"} className="bottom-8 right-8 md:bottom-12 md:right-24" />
            <Zigzag className="top-16 right-16 md:top-24 md:right-48" width={100} color={theme === "dark" ? "#CA8A04" : "#f97316"} />
            <Zigzag className="bottom-12 left-12 md:bottom-20 md:left-32" width={80} color={theme === "dark" ? "#A1A1AA" : "#000000"} />
                        ...
                        >
                            ...
                            <div className="h-6 md:h-8 w-full border-b-2 md:border-b-4 border-black dark:border-gray-200 bg-amber-400 dark:bg-yellow-700 absolute top-0 left-0">
                                <div className="flex gap-1 md:gap-2 h-full items-center ml-2 md:ml-4">
                                    ...
                                    <span className={`${space_mono.className} text-[10px] md:text-xs ml-1 md:ml-2 text-black dark:text-gray-100`}>DEVELOPER_WISDOM.js</span>
                                </div>
                            </div>
                            ...
                            <blockquote className="text-center mb-2 md:mb-4">
                                <p className={`${fira_code.className} text-base sm:text-lg md:text-xl lg:text-2xl font-semibold mb-3 md:mb-4 dark:text-gray-100`}>"{quote.text}"</p>
                                <footer className={`${jetbrains_mono.className} text-sm md:text-lg dark:text-gray-100`}>
                                    <motion.span 
