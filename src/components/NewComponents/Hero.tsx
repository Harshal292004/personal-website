...
export const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="relative py-20 md:py-28 overflow-hidden select-none"
    >
      <motion.div
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-6">
          <span
            className={`${space_mono.className} text-xs text-[#d97706] font-semibold tracking-wider uppercase bg-[#ebd9c8]/30 dark:bg-amber-900/20 px-2 py-1 rounded`}
          >
            About Me
          </span>
          <span className="flex-1 h-[1px] bg-dashed border-t border-[#ebd9c8] dark:border-zinc-800" />
          <span
            className={`${space_mono.className} text-[10px] text-zinc-400 dark:text-zinc-500`}
          >
            Nagpur, India
          </span>
        </div>
        ...
        <div className="relative mb-10">
          <h1
            className={`${lora.className} text-3xl sm:text-4xl md:text-5xl font-normal leading-tight text-zinc-900 dark:text-zinc-50`}
          >
            Building{" "}
            <span className="relative inline-block italic font-medium text-[#d97706] px-1">
              software
              <Underline
                className="absolute left-0 bottom-[-5px] w-full h-3 text-[#d97706] opacity-70"
                color="currentColor"
              />
            </span>{" "}
        ...
        {/* Bio Text */}
        <div
          className={`${lora.className} text-lg md:text-xl text-zinc-700 dark:text-zinc-300 leading-relaxed space-y-6 font-light`}
        >
          <p>
            I am a 4th-year{" "}
            ...
            from Nagpur, India, passionate about building software. I maily work
            on web development, open source, and personal software
            projects.{" "}
          </p>
          <p>
            My interests lie in{" "}
            ...
            . I thrive on innovation, collaboration, and leveraging technology
