      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-12 relative before:absolute before:left-3 before:top-2 before:bottom-2 before:w-[1px] before:bg-dashed before:border-l before:border-[#ebd9c8] dark:before:border-zinc-800">
          ...
          >
            ...
            <span
              className={`${space_mono.className} text-[10px] text-zinc-400 dark:text-zinc-500 block mb-2`}
            >
              Open Source Contribution • 2025
            </span>

            <h3
              className={`${lora.className} text-xl md:text-2xl font-medium text-zinc-900 dark:text-zinc-50 mb-4`}
            >
              Kubeflow Contributor
            </h3>

            <div
              className={`${lora.className} text-zinc-700 dark:text-zinc-300 font-light leading-relaxed space-y-3 mb-6`}
            >
              <p>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {["GoLang", "Kubernetes", "DevOps", "Cloud Native"].map(
                (tech) => (
                  <span
                    key={tech}
          ...
          >
            ...
            >
              In addition to open source, I spend late nights building projects
              and exploring different tech.
            </p>
