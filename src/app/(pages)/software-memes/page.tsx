    ...
    <div className="w-full h-screen flex items-center justify-center relative bg-gradient-to-br from-emerald-50 to-green-50 dark:from-gray-900 dark:to-gray-800 overflow-hidden transition-colors duration-300">
      ...
      >
        <Circle 
          ...
          className="absolute top-1/3 right-1/5 md:block hidden" 
        />
        <Triangle
          size={60}
          color={theme === "light" ? "#10b981" : "#eab308"}
          className="absolute bottom-1/4 left-1/4 md:block hidden"
          rotation={-15}
        />
        <Square 
          size={40} 
          color={theme === "light" ? "#047857" : "#10b981"} 
          className="absolute top-2/3 left-1/3 md:block hidden" 
        />
        <Curly
        ...
        />
        <Curly
          className="absolute top-1/4 right-1/3 md:block hidden"
          width={80}
          height={20}
