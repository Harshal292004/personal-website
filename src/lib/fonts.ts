...
const space_mono = Space_Mono({ weight: "700", style: "normal",subsets: ["latin"] });
...
export {fira_code,space_grotesk,space_mono,jetbrains_mono,pixelify_sans,vt323,silkscreen,press_start_2p,share_tech_mono}